...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[FK_Product_Category]') and OBJECTPROPERTY(id, N'IsForeignKey') = 1)
...
ALTER TABLE [dbo].Marca WITH NOCHECK ADD 
...
ALTER TABLE [dbo].ProductImage ADD 
	CONSTRAINT [FK_ProductImage_I] FOREIGN KEY 
	(
		ImageId_FK
...
ALTER TABLE [dbo].ProductImage ADD 
	CONSTRAINT [FK_ProductImage_P] FOREIGN KEY 
	(
		ProductId_FK
